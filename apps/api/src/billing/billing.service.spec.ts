...
function service(secretConfigure: string | null = SECRET) {
  ...
  return {
    ...
    billing: new BillingService(
      ...
      config,
      credits as never,
      // L'école, la boutique, Stripe Connect, les courriels et les attestations
      // ne servent pas ces scénarios d'abonnement : on les passe vides plutôt
      // que de les simuler, pour que le test ne parle que de ce qu'il vérifie.
      {} as never,
      {} as never,
      {} as never,
      {} as never,

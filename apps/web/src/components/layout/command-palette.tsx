...
const DESTINATIONS: Dest[] = [
  ...
  { label: "Admin — Utilisateurs", href: "/admin/utilisateurs", group: "Admin", keywords: "users comptes" },
  { label: "Admin — Établissements", href: "/admin/etablissements", group: "Admin", keywords: "organisations comptes" },

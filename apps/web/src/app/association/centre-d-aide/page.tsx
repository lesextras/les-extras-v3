...
export default function CentreAide() {
  return (
    <>
      ...
      {/* ---------------------------------------------------------------- l'entrée */}
      <section className="aide-hero relative overflow-hidden rounded-[28px] border-2 border-[#C7C4F2] p-7 sm:p-10">
        ...
        <div className="relative grid items-center gap-8 lg:grid-cols-[minmax(0,1fr)_300px]">
          <div>
            ...
            <p className="mt-3 max-w-[46ch] text-lg leading-relaxed text-[#3B3A66]">
...
const ANIMATIONS = `
.aide-hero { background: radial-gradient(120% 130% at 10% 0%, #FFFFFF 0%, #ECEBFC 55%, #DEDCFA 100%); }
...
.aide-lueur-a { width:220px; height:220px; background:#4F46E5; top:-80px; right:14%; animation: aide-flotte 18s ease-in-out infinite; }
...
const RACCOURCIS = [
  {
    href: '/chemin',
    titre: 'Le chemin',
    detail: 'Les deux parcours, étape par étape.',
  ...
  },
  {
    ...
    detail: 'Trois portes, une par situation.',
    ...
    questions: [
      {
        ...
        r: 'Par le chemin : les étapes dans l’ordre, avec ce qu’il faut pour chacune. Rien à ouvrir pour le lire.',
        lien: { libelle: 'Voir le chemin', href: '/chemin' },
      },
      {
        q: 'Je n’ai pas encore d’association',
        r: 'Ouvre un espace particulier : tu suis le chemin et tu crées ta structure en route.',
        lien: { libelle: 'Ouvrir un espace', href: '/inscription?type=particulier' },
      },
      {

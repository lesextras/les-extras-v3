  ...
  return (
    <div className="space-y-20">
      ...
      {/* Missions ouvertes — aperçu flouté. Section absente s'il n'y en a pas.
          Une API en panne n'est PAS « aucune mission » : sans distinguer les
          deux, la section disparaissait en silence et la page laissait croire
          que le réseau était vide. Le catalogue traite déjà ce cas ainsi. */}
      {error ? (
        <section className="space-y-3">
          <h2 className="text-2xl font-semibold tracking-tight text-foreground">
            Missions momentanément indisponibles
          </h2>
          <p className="text-muted-foreground">
            Nous n’arrivons pas à afficher les renforts ouverts pour l’instant. Réessayez dans
            quelques instants.
          </p>
        </section>
      ) : missions.length > 0 ? (

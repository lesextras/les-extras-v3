    ...
    body: [
      ...
      },
      {
        ...
        points: [
          ...
          'Lecture automatique des pièces du dossier de conformité (pièce d’identité, diplôme, extrait de casier judiciaire, justificatifs) : au moment du dépôt, le document est transmis à un moteur d’intelligence artificielle (Google Gemini, ou Anthropic Claude en secours) qui en extrait le type, le nom et les dates, sans conservation du document par le prestataire au-delà de l’appel. Cette lecture n’est qu’une aide : la vérification et la validation restent faites par une personne. La personne concernée peut demander à assoc.adepa@gmail.com que ses pièces soient contrôlées sans lecture automatique.',

    ...
    body: [
      ...
      },
      {
        ...
        points: [
          ...
          'Lecture automatique des pièces du dossier de conformité (pièce d’identité, diplôme, justificatifs) : au moment du dépôt, le document est transmis à un moteur d’intelligence artificielle (Google Gemini, ou Anthropic Claude en secours) qui en extrait le type, le nom et les dates. Le prestataire traite le document le temps de l’appel ; il peut en garder une trace pour une durée limitée, selon ses propres conditions, à des fins de sécurité. L’extrait de casier judiciaire et le relevé d’identité bancaire ne sont JAMAIS transmis : ils sont contrôlés par une personne uniquement. Cette lecture n’est qu’une aide : la vérification et la validation restent faites par une personne. La personne concernée peut demander à assoc.adepa@gmail.com que ses pièces soient contrôlées sans lecture automatique.',
          ...
          'Les fichiers déposés (diplômes, justificatifs, pièces jointes) sont stockés sur un serveur auto-hébergé, sur la même infrastructure. Ils ne sont confiés à aucun prestataire tiers pour leur conservation ; seule la lecture automatique décrite ci-dessus les transmet, le temps de l’appel.',

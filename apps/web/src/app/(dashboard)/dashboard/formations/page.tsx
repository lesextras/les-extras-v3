// Espace Formation (dashboard), selon le type de compte.
// ESTABLISHMENT : le catalogue ADéPA mis en avant + les formations du compte.
  ...
  return (
    <div className="space-y-8">
      <PageHeader
        ...
        subtitle={
          isEstablishment
            ? "Le catalogue ADéPA, et les formations de votre compte."
      ...
      {/* ESTABLISHMENT : le catalogue ADéPA. */}
      {isEstablishment ? (
        <Card className="border-primary/25 bg-primary/5">
          <CardContent className="flex flex-col gap-3 p-5">
            ...
            <p className="text-sm text-muted-foreground">
              Des formations animées par des formateurs du réseau, finançables (CPF, OPCO), sur
              devis.
            </p>
      ...
      <div className="space-y-4">
        <SectionTitle
          title={isEstablishment ? "Mes formations" : "Mes programmes & sessions"}
        />

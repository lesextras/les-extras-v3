  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[1.35fr_1fr]">
      ...
      <Link
        ...
        className="group relative bloc-nuit overflow-hidden rounded-3xl bg-[hsl(222,21%,15%)] p-8 ring-1 ring-border transition-all duration-300 hover:-translate-y-1 hover:shadow-card md:p-10"
      >

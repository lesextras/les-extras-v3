...
/**
 * Design system "Quietly Bold" — LES EXTRAS v3.
 * Palette chaleureuse, pro, light-only. Les couleurs sont pilotées par des
 * variables CSS (voir src/styles/globals.css) pour rester cohérentes partout.
 */
const config: Config = {
  darkMode: ['class'],
  content: [
